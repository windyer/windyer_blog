...
class windyerUserCreationForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        try:
            windyerUser._default_manager.get(username=username)
        except windyerUser.DoesNotExist:
            return username
    ...
    def clean_email(self):
        ...
        # 判断是这个email 用户是否存在
        try:
            windyerUser._default_manager.get(email=email)
        except windyerUser.DoesNotExist:
            return email
        raise forms.ValidationError(
    ...
    def save(self, commit=True):
        user = super(windyerUserCreationForm, self).save(commit=False)
...
class windyerPasswordRestForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and email:
            try:
                self.user = windyerUser.objects.get(
