...
from windyer_auth.forms import windyerUserCreationForm, windyerPasswordRestForm
from windyer_auth.models import windyerUser
from windyer_system.models import Notification
import time
import datetime
...
class UserControl(View):
    ...
    def register(self, request):
        ...
        form = windyerUserCreationForm(request.POST)
    ...
    def forgetpassword(self, request):
        ...
        form = windyerPasswordRestForm(request.POST)
    ...
    def resetpassword(self, request):
        ...
        try:
            ...
            user = windyerUser._default_manager.get(pk=uid)
        except (TypeError, ValueError, OverflowError, windyerUser.DoesNotExist):
            user = None
    ...
    def changetx(self, request):
        ...
        filedir = "windyer_auth/static/tx/"
