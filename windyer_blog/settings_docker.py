...
env = {
    'SECRET_KEY': os.environ.get('SECRET_KEY', 'I use windyer'),
    'WEBSITE_TITLE': os.environ.get('WEBSITE_TITLE', u'windyer'),
    'WEBSITE_WELCOME': os.environ.get('WEBSITE_WELCOME', u'欢迎来到windyer'),
    ...
    'EMAIL_SUBJECT_PREFIX': os.environ.get('EMAIL_SUBJECT_PREFIX', u'windyer'),
...
ROOT_URLCONF = 'windyer_blog.urls'
...
WSGI_APPLICATION = 'windyer_blog.wsgi.application'
...
STATIC_ROOT = '/windyer_blog/static/'

# 设置user model
AUTH_USER_MODEL = "windyer_auth.windyerUser"


# log配置
LOG_FILE = "/var/log/windyer/all.log"
